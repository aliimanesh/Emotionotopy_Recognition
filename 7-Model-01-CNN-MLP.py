...
checkpoint_callback = CustomModelCheckpoint(
    filepath='/content/drive/My Drive/Colab Notebooks/Models/Model_01_CNN_MLP_{epoch}.keras',
...
model.save('/content/drive/My Drive/Colab Notebooks/Models/emotiodel_01_CNN_MLP_final.keras')
plt.ioff()