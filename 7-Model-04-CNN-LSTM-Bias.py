...
checkpoint_callback = CustomModelCheckpoint(
    filepath='/content/drive/My Drive/Colab Notebooks/Models/Model-04-CNN-LSTM-BiasS_{epoch}.keras',
...
model.save('/content/drive/My Drive/Colab Notebooks/Models/Model-04-CNN-LSTM-Bias.keras')
plt.ioff()