...
emotions = pd.read_csv("/content/drive/My Drive/Colab Notebooks/emotion_dimension_normalized.csv")
...
checkpoint_callback = CustomModelCheckpoint(
    filepath='/content/drive/My Drive/Colab Notebooks/Models/Model-03-CNN-MLP-Bias_{epoch}.keras',
...
model.save('/content/drive/My Drive/Colab Notebooks/Models/Model-03-CNN-MLP-Bias_final.keras')
plt.ioff()